...
;(function (root, factory) {
    if (typeof define === 'function' && define.amd) {
        ...
        var TableExport = function (selectors, options, isUpdate) {
            ...
            self.selectors.each(function () {
                ...
                function checkCaption(exportButton) {
                    if($('.wrap-export').length > 0){
                        $('.wrap-export').append(exportButton);
                    }
                    else{
        ...
        TableExport.prototype = {
             ...
             */
            xlsx: {
                defaultClass: "xlsx btn-secondary",
                buttonContent: "<i class='menu-icon mdi mdi-file-excel'></i> Export",
