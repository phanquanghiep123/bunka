...
<div class="dropdown">
    ...
    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
        <a class="dropdown-item modal-edit" href="{{route($_SEFF->_ROUTE_FIX . '.edit',$id)}}">_edit_</a>
        <a class="dropdown-item modal-delete" href="{{route($_SEFF->_ROUTE_FIX . '.destroy',$id)}}"  data-id="{{$id}}">_delete_</a>
    </div>
</div>
@endhook