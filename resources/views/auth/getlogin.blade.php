      ...
      <div class="content-wrapper d-flex align-items-center auth auth-bg-1 theme-one">
        <div class="row w-100">
          <div class="col-lg-6 col-xl-4 mx-auto">
           <div class="text-center mb-2"><img src="{{asset('/images/logo-mini.png')}}"></div>
            <div class="auto-form-wrapper">
             <h4 class="text-center mb-4">_LOGIN_</h4>
              <form method="post" action="{{route('auth.postlogin')}}">
                ...
                <div class="form-group">
                  <label class="label">_LANGUAGES_</label>
                  <div class="input-group">
                    <select class="form-control"  onchange="return changeLang($(this).val());">
                       @foreach ($langs as $key => $value)
                        <option value="{{$value->id}}" {{($value->id == $lang_id ? 'selected' : '')}}><img style="width: 30px;height: 30px;margin-right: 10px;" class="img-xs rounded-circle" src="{{asset(@$value->icon)}}" alt="Profile image"> {{$value->name}} </option>
                       @endforeach
                    </select>
                ...
                <div class="form-group">
                  <label class="label">_USERNAME_</label>
                  <div class="input-group">
                ...
                <div class="form-group">
                  <label class="label">_PASSWORD_</label>
                  <div class="input-group">
                ...
                <div class="form-group">
                  <input type="hidden" name="goto" value="{{@\Request::get('goto')}}">
                  <button type="submit" class="btn btn-primary submit-btn btn-block">_LOGIN_</button>
                </div>
                <div class="form-group d-flex justify-content-between">
                  <div class="form-check form-check-flat mt-0">
                    <label class="form-check-label">
                      <input type="checkbox" name="remember" class="form-check-input" checked=""> _REMIMEMBER_
                    <i class="input-helper"></i></label>
                  </div>
                  <a href="{{route('auth.getforgot')}}" class="text-small forgot-password text-black">_FORGETPASSWORD_</a>
                </div>
        ...
        try{
            if(typeof v2.responseJSON != undefined){
                ...
                if(typeof v2.responseJSON._redirect != undefined && v2.responseJSON._redirect == 1){
                    document.location.href = responseJSON._redirect_url;
                }
            }
        }catch(e){
