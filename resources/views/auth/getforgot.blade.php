          ...
          <div class="col-lg-6 col-xl-4 mx-auto">
           <div class="text-center mb-2"><img src="{{asset('/images/logo-mini.png')}}"></div>
            <div class="auto-form-wrapper">
             ...
             <p class="text-center text-secondary mb-4">Enter your email to reset your password:</p>
              <form method="post" action="{{route('auth.postforgot')}}">
				        @if (session('message'))
                ...
                <div class="form-group">
                  <button class="btn btn-primary submit-btn btn-block">Request</button>
                </div>
                <div class="form-group text-center">
                  <a href="{{route('auth.getlogin')}}" class="text-small text-black">Login</a>
                </div>
              </form>
            </div>
